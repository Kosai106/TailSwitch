...
- The SVG's original `0 0 130 120` canvas placed approximately 53×53 units of artwork near its center. Its viewBox is now a square `34 29 63.04 63.04`, leaving roughly five source units around the artwork for a balanced tray margin and anti-aliasing safety.
...
- A desktop test confirms the embedded icon renders and occupies at least 51×51 pixels of a 64×64 canvas, with at least four rendered pixels of margin. Host Wayland smoke startup continues to pass.
